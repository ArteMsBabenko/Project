...
import service.SupportingDocumentService;
...
public class ApplicationController {
	...
	public String createApplication(@RequestParam Map<String, String> form,	@RequestParam("supportingDocument") MultipartFile[] supportingDocuments,
		...
		if (bindingResult.hasErrors() || form.get("speciality") == "" || !znoMarksErrors.isEmpty() || !supportingDocumentErrors.isEmpty()) {
            ...
            model.addAttribute(!znoMarksErrors.isEmpty() ? "znoMarksErrorMessage" : "", "Errors were found while filling in EIT scores: " +
    ...
    model.addAttribute("specialities", specialtyService.findByRecruitmentCompletedFalse());
		...
		if (applicationExists) {
			model.addAttribute("applicationExistsMessage", "Application for the selected specialty already exists!");
			model.addAttribute("specialities", specialtyService.findByRecruitmentCompletedFalse());
