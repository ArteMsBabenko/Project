drop database if exists Data_Base1;
create database Data_Base1 char set utf8;
...
alter table rating_list
    ...
    values (1, 'Admission Committee', 'Administrator', 'admissions.office.info@gmail.com', '$2a$08$OkqR9ogYtRouCIFmOTznwOria8hQvg5rJBhMdAl.BCxs2j5CXSQhy', true);
