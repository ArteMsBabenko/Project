...
public class ApplicationController {
	...
	public String createApplication(@RequestParam Map<String, String> form,	@RequestParam("files") MultipartFile[] supportingDocuments,
		...
		if (bindingResult.hasErrors() || form.get("speciality") == "" || !znoMarksErrors.isEmpty() || !supportingDocumentErrors.isEmpty()) {
            ...
            model.addAttribute(!znoMarksErrors.isEmpty() ? "message" : "", "Errors were found while filling in the EIT points: " +
                    znoMarksErrors.values() + ". Try filling out the form again!");
                    model.addAttribute(form.get("speciality") == "" ? "specialityError" : "", "Field Specialty cannot be empty!");
